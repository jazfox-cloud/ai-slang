export const slangs = [
  ...
  },
  {
    ...
    extraSections: [
      ...
      {
        heading: "Flag, label, and disclosure do not always mean the same thing",
        paragraphs: [
      ...
      {
        heading: "Common visible AI disclosure labels",
        bullets: [
      ...
      {
        heading: "How machine-readable signals can become visible labels",
        paragraphs: [
    ...
    faqItems: [
      ...
      {
        question: "Is “flag as AI” the same as adding an AI label?",
        answer: "No. Flagging usually sends a suspicion or policy concern for moderation, while adding an AI label creates a notice that viewers can see. A platform may connect the two processes, but they are not inherently the same."
      },
      {
        question: "Does an AI flag prove that content was AI-generated?",
        answer: "No. A user flag is an allegation or review signal, and an automated detector can also be wrong. Confirmation requires stronger evidence or a platform decision based on its own policy and signals."
      },
      {
        question: "Can metadata trigger a visible AI label?",
        answer: "Yes. A platform can read supported provenance metadata such as C2PA Content Credentials and use it as one input when applying a visible label, but metadata and the label remain different things."
      },
      {
        question: "Is “AI-generated flag” a standard metadata field?",
        answer: "No. It is ambiguous informal wording. Stable technical names include C2PA Content Credentials, the “c2pa.ai-disclosure” assertion, and IPTC Digital Source Type values such as “TrainedAlgorithmicMedia”."
      },
      {
    ...
    furtherReading: [
      ...
      {
        label: "YouTube: Understanding “How this content was made” disclosures",
        url: "https://support.google.com/youtube/answer/15447836"
      },
      {
        label: "Hacker News: Add flag for AI-generated articles",
      ...
      {
        label: "TikTok: AI-generated content labels and Content Credentials",
        url: "https://newsroom.tiktok.com/more-ways-to-spot-shape-and-understand-ai-generated-content?lang=en-GB"
      },
      {
        label: "C2PA 2.4: AI Disclosure assertion",
        url: "https://spec.c2pa.org/specifications/specifications/2.4/specs/ContentCredentials.html#_ai_disclosure"
      },
      {
        label: "IPTC: Metadata guidance for AI-generated media",
        url: "https://iptc.org/news/iptc-publishes-metadata-guidance-for-ai-generated-synthetic-media/"
      },
      {
        label: "Google Merchant Center: AI-generated content metadata",

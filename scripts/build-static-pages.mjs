...
const policyPages = [
  ...
  },
  {
    ...
    sections: [
      ["Review status", "Last reviewed July 13, 2026. Each entry labels its source type and last-checked date so readers can separate stable technical terms, product language, community slang, and editorial shorthand."],
